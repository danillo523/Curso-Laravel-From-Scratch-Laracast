...
<label for="<?php echo e($name); ?>" class="block mb-2 uppercase font-bold text-xs text-gray-700">
    <?php echo e(ucwords($name)); ?>

</label>
<?php /**PATH /home/danillo/example-app/resources/views/components/form/label.blade.php ENDPATH**/ ?>