...
<section class="py-8 max-w-4xl mx-auto">
    ...
    <div class="flex">
        <aside class="w-48 flex-shrink-0">
            ...
            <ul>
                <li>
                    <a href="/admin/posts" class="<?php echo e(request()->is('admin/posts') ? 'text-blue-500' : ''); ?>">Todos os posts</a>
                </li>

                <li>
                    <a href="/admin/posts/create" class="<?php echo e(request()->is('admin/posts/create') ? 'text-blue-500' : ''); ?>">Novo post</a>
                </li>
            </ul>
        </aside>
...
<
<?php /**PATH /home/danillo/example-app/resources/views/components/setting.blade.php ENDPATH**/ ?>